    ...
    public partial class Form_RentalHistory : Form
    {
        ...
        private void ConfigureDataGridView()
        {
            ...
            if (dgv_RentalHistory.Columns.Count > 0)
            {
                ...
                dgv_RentalHistory.Columns["STARTDATE"].HeaderText = "Ngày bắt đầu";
                dgv_RentalHistory.Columns["ENDDATE"].HeaderText = "Ngày kết thúc";
                ...
                dgv_RentalHistory.Columns["STARTDATE"].Width = 100;
                dgv_RentalHistory.Columns["ENDDATE"].Width = 100;
                dgv_RentalHistory.Columns["REASON_FOR_LEAVING"].Width = 150;
                dgv_RentalHistory.Columns["BUILDINGID"].Width = 90;
                ...
                // Ẩn cột BUILDINGID nếu không cần hiển thị
                dgv_RentalHistory.Columns["BUILDINGID"].Visible = false;
            }
