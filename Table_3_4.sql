...
-- 9-4
=======
>>>>>>> 626e2fb680b5f81822d1b8f185ceb19c098db8af:RentEase_MSQL.sql
...
CREATE TABLE BILLDETAIL (
	...
	BILLID               	VARCHAR(10) NOT NULL COMMENT 'ID hóa đơn',
    ID				VARCHAR(10) NOT NULL COMMENT 'ID dịch vụ',
...
-- ADD CONSTRAINT FK_BILLDETAIL_WATER_ELECTRICITY FOREIGN KEY (FIGUREID) REFERENCES WATER_ELECTRICITY(FIGUREID) ON DELETE CASCADE;
