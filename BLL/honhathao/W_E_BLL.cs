...
namespace BLL.honhathao
{
    public class W_E_BLL
    {
        ...
        public static string Add_W_E(string buildingID, string o_w, string n_w, string o_e, string n_e, string month)
        {
            return W_E_Access.add_W_E(buildingID, o_w, n_w, o_e, n_e, month);
        }
